...
export default function HeroSection() {
    return (
        <div className="hero">
            ...
            <p className="heroinfo">I am a <span className="spacing">Full Stack Developer</span> and <span className="spacing">an Avid Reader</span> with a knack for building things. Currently working with AWS ElasticSearch Team. My Educational Background includes B.Tech from NIT Surat.</p>
